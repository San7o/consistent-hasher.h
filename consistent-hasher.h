...
//
// This library implements function to add and remove nodes, and to
// get the closest node from an item. You can use this inside your
// hashmap logic to move only NUM_ITEMS / NUM_NODES items when
// resizing.
//
// Additional info:
